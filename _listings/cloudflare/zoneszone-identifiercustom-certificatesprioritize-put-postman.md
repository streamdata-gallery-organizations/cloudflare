{
  "info": {
    "name": "CloudFlare If a zone has multiple SSL certificates, you can set the order in which they should be used during a request",
    "_postman_id": "a12e9b06-3c16-4aa1-9c5e-338040ab5f9b",
  ...
  "item": [
    {
      ...
      "item": [
        {
          "id": "35958bd6-ad26-459c-810f-0119a7981e5b",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "2bd20493-0dcb-4ec1-ae6e-120a2f933554"
            }
          ]
        },
        {
          "id": "0016c61e-238c-4196-8a15-e4d3c1d5de8a",
          "name": "cloudflare-app-subscription-api",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "268fe5a1-41f1-4206-a482-671b1cb2bde3"
            }
          ]
        }
      ]
    },
    {
      ...
      "item": [
        {
          "id": "8acf5380-7ea1-4637-9c0f-afb9db21a038",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "52e0b37f-19c2-4095-9605-ace0bc29761b"
            }
          ]
        },
        {
          "id": "a39a5638-91d3-472c-8c14-c493ed897ecd",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "ab52b7a9-bc7f-4086-ad43-f4f8cdca1743"
            }
          ]
        },
        {
          "id": "1766318f-e0dc-4b52-bd65-0af6645cef89",
          "name": "cloudflare-custom-pages-for-a-zone-api",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "eca66d70-9c27-4f17-9e8f-298e9a4b1bbe"
            }
          ]
        }
      ]
    },
    {
      ...
      "item": [
        {
          "id": "a1c9e15a-95e0-4db0-aa35-08a55d79d420",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "91b9eef9-af71-4e47-8e9b-9fa154516590"
            }
          ]
        },
        {
          "id": "13cd511b-9ca0-43bc-ba78-f590ee33dbd2",
          "name": "cloudflare-custom-ssl-for-a-zone-api",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "96d01cc1-8404-4aaf-8c77-9c6b3be176f2"
            }
          ]
        },
        {
          "id": "3e83afe0-a086-425b-8397-0bb4bfcf1543",
          "name": "cloudflare-custom-ssl-for-a-zone-api",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "e2ad2439-25fe-4387-beac-7fc3cf4fda21"
            }
          ]
        },
        {
          "id": "48dc4b17-c81f-4f70-9364-50c9cce3d6f7",
          "name": "cloudflare-custom-ssl-for-a-zone-api",
          "request": {
            "url": "http://example.com/api/zones/:zone_identifier/custom_certificates/:identifier",
            "method": "DELETE",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "db9d6183-0ea1-4003-856c-8abe8506a1b8"
            }
          ]
        },
        {
          "id": "7df0f32e-eeba-4abe-b3ec-0998b5f60973",
          "name": "cloudflare-custom-ssl-for-a-zone-api",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "82e3f88a-2a56-4ee4-b41d-0d3fd6e22a2c"
            }
          ]
        },
        {
          "id": "13d10307-b3c8-4393-b183-0d6b3a01a07f",
          "name": "cloudflare-custom-ssl-for-a-zone-api",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "90a152a0-9607-4c63-8774-c1d1aea75efa"
            }
          ]
        }
      ]
